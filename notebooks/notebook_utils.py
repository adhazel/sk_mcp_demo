"""
Notebook utilities for the sk_mcp_demo project.
...
def setup_notebook_environment(project_name: str = "sk_mcp_demo") -> Path:
    """
...
def notebook_setup(environment: str = "local", project_name: str = "sk_mcp_demo"):
    """
