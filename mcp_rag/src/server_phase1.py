...
This server definition is phase 1 in a multi-phase tutorial series, focusing on setting up the server and basic instrumentation, such as logging and event storage.
